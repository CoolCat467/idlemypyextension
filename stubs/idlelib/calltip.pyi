...
class Calltip:
    ...
    def force_open_calltip_event(self, event: Event[Misc] | None) -> str: ...
    def try_open_calltip_event(self, event: Event[Misc] | None) -> None: ...
    def refresh_calltip_event(self, event: Event[Misc] | None) -> None: ...
